...
os.environ['CUDA_VISIBLE_DEVICES'] = "1" ##不加上的话，内存会报错
...
train_dir = '/root/DD/NSM/Tuzhuang/Tuzhuang/Training/'  # 训练集数据
val_dir = '/root/DD/NSM/Tuzhuang/Tuzhuang/Ver/' # 验证集数据
nb_classes= 8
nb_epoch = 10
batch_size = 32
...
# 模型保存
model.save('Tuzhuang_model_1011.h5')
