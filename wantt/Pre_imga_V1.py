...
# 指定找到文件后，另存为的文件夹路径
outDir = os.path.abspath('C:/Sunaoxue/IT_Project/warrantysmart/Data/N')

#指定第一个文件夹的位置
# imageDir1 = os.path.abspath('C:/Sunaoxue/IT_Project/warrantysmart/Data/AbnormalCase/ExternalDamage')
imageDir1 = os.path.abspath('C:/Sunaoxue/IT_Project/warrantysmart/Data/NormalCase/moderatelydamaged')
...
#对于第二个文件夹路径，做同样的操作
imageDir2 = os.path.abspath('C:/Sunaoxue/IT_Project/warrantysmart/Data/Normal')
image2 = []
imgname2 = []
